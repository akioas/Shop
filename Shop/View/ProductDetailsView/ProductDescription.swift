            ...
            HStack {
                ...
                VStack {
                    ...
                    HStack(spacing: 9) {
                        ...
                        ForEach((0..<Int(data.rating)), id: \.self) { _ in
                        ...
                        ForEach((Int(data.rating)..<maxStars), id: \.self) { _ in
                                    ...
                                    selectedCapacity = capacities.firstIndex(of: capacity) ?? 0
                                        ...
                                        ZStack {
                                            if selectedCapacity == capacities.firstIndex(of: capacity) {
                                                ...
                                                Text(capacity + " GB")
                                                    .foregroundColor(.white)
                                                    .font(.custom("MarkPro-Heavy", size: 13))
                                            } else {
                                                Color(.clear)
                                                    .frame(width: 80, height: 31.5, alignment: .center)
                                                Text(capacity + " gb")
        ...
        ZStack {
            ...
            HStack {
                ...
                if let price = data?.price {
                    Text("$" + (price.formattedWithSeparator) + ".00")
                }
                Spacer()
            }
            .font(.custom("MarkPro-Heavy", size: 20))
            .foregroundColor(Color.white)
        }
    }
}
